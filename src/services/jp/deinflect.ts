/*
 * Vendored from the 10ten Japanese Reader (https://github.com/birchill/10ten-ja-reader),
 * src/background/deinflect.ts. Licensed GPL-3.0-or-later — see LICENSE-10ten in the
 * repo root. `const enum` was changed to `enum` so the values survive esbuild's
 * isolated-modules transpilation; otherwise unchanged.
 */
